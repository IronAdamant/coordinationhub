...
| `coordinationhub/core.py` | `CoordinationEngine` — all 27 MCP tool methods + helpers (~453 LOC) | db, agent_registry, lock_ops, conflict_log, notifications, graphs, visibility, assessment, paths, context |
