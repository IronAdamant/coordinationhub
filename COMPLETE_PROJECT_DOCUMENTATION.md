...
| `coordinationhub/agent_registry.py` | 428 | Agent lifecycle: register, heartbeat, deregister, lineage management |
...
| `coordinationhub/cli_tasks.py` | 152 | CLI commands for the task registry |
| `coordinationhub/cli_utils.py` | 51 | Shared CLI helper functions used by all cli_* sub-modules |
| `coordinationhub/cli_vis.py` | 232 | Change awareness, audit, graph, and assessment CLI commands |
...
| `coordinationhub/mcp_server.py` | 478 | HTTP-based MCP server for CoordinationHub — zero external dependencies |
...
| `coordinationhub/plugins/dashboard/dashboard.py` | 141 | Web dashboard for CoordinationHub — zero external dependencies |
...
| `coordinationhub/plugins/dashboard/dashboard_js.py` | 447 | Client-side JavaScript for the CoordinationHub dashboard |
...
| `coordinationhub/scan.py` | 274 | File ownership scan for CoordinationHub |
...
coordinationhub/
  ...
  agent_registry.py     — Agent lifecycle: register, heartbeat, deregister, lineage management (~428 LOC)
  ...
  db_schemas.py         — Canonical SQLite schema definitions for CoordinationHub (~299 LOC)
  ...
  mcp_server.py         — HTTP-based MCP server for CoordinationHub — zero external dependencies (~478 LOC)
  ...
  scan.py               — File ownership scan for CoordinationHub (~274 LOC)
