...
@_command()
def cmd_acquire_lock(engine, args):
...
@_command()
def cmd_release_lock(engine, args):
...
@_command()
def cmd_refresh_lock(engine, args):
...
def cmd_lock_status(engine, args):
...
@_command()
def cmd_admin_locks(engine, args):
...
@_command()
def cmd_acknowledge_broadcast(engine, args):
...
@_command()
def cmd_wait_for_broadcast_acks(engine, args):
...
@_command()
def cmd_acknowledge_handoff(engine, args):
...
@_command()
def cmd_complete_handoff(engine, args):
...
@_command()
def cmd_cancel_handoff(engine, args):
...
@_command(replica=True)
def cmd_get_handoffs(engine, args):
...
@_command()
def cmd_wait_for_handoff(engine, args):
...
@_command()
def cmd_wait_for_locks(engine, args):
...
@_command()
def cmd_await_agent(engine, args):
...
@_command()
def cmd_send_message(engine, args):
...
@_command(replica=True)
def cmd_get_messages(engine, args):
...
@_command()
def cmd_mark_messages_read(engine, args):
