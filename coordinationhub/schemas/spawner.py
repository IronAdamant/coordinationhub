...
TOOL_SCHEMAS_SPAWNER: dict[str, dict] = {
    "spawn_subagent": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "source": {
                    "type": "string",
                    "description": "Source system that will perform the spawn (e.g. 'stdio_adapter')",
                    "default": "external",
                },
            },
    ...
    "report_subagent_spawned": {
        "description": (
            ...
            "Any IDE/CLI (stdio_adapter, etc.) calls this after "
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "source": {
                    "type": "string",
                    "description": "Source system that performed the spawn (e.g. 'stdio_adapter')",
                    "default": "external",
                },
                "caller_agent_id": {
                    "type": "string",
