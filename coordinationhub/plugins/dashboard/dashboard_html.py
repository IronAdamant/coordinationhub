...
Pure data — a single ``DASHBOARD_HTML`` string constant holding the
CSS + HTML + client-side JavaScript.  Kept separate from
:mod:`dashboard` so the Python logic module stays well under the
project's 500-code-LOC rule.
"""
